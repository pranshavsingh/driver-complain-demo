...
export default function WhatsAppRegisterComplaintScreen(): ReactElement {
  ...
  return (
    <View style={styles.screen}>
      {/* 1. Status Bar & WhatsApp Top Header (Padded for Status Bar Notch) */}
      ...
      >
        ...
        >
          ...
          <View style={styles.systemBubble}>
            <Text style={styles.systemText}>
              👋 Welcome to Dispatch Support! Type your complaint below or record a voice note. You can also send images and videos of vehicle issues.
            </Text>
        ...
        {/* 4. WhatsApp Chat Bottom Action Bar (No Tab Bar Overlap) */}
...
const styles = StyleSheet.create({
  ...
  // Header padding handles status bar notch cleanly
  whatsappHeader: {
    flexDirection: 'row',
    alignItems: 'center',
  ...
  // Sleek Vehicle input box section
  vehicleInputSection: {
  ...
  outgoingBubble: {
    alignSelf: 'flex-end',
    backgroundColor: '#DCF8C6', // WhatsApp classic light green bubble
    borderRadius: 12,
  ...
  // WhatsApp bottom bar - Clean padding above bottom tabs
  whatsappInputBar: {
    flexDirection: 'row',
    alignItems: 'center',
  ...
  micCircleBtn: {
    ...
    height: 38,
    borderRadius: 19,
    backgroundColor: '#075E54', // WhatsApp mic button
    alignItems: 'center',
    justifyContent: 'center',
  },
  sendCircleBtn: {
    ...
    height: 38,
    borderRadius: 19,
    backgroundColor: '#075E54', // WhatsApp send button
    alignItems: 'center',
    justifyContent: 'center',
  },
  sendBtnDisabled: {
