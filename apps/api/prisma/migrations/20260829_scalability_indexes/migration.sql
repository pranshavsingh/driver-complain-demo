...
CREATE INDEX IF NOT EXISTS idx_complaint_title_trgm
  ON "Complaint" USING gin ("title" gin_trgm_ops);

CREATE INDEX IF NOT EXISTS idx_complaint_desc_trgm
  ON "Complaint" USING gin ("description" gin_trgm_ops);

CREATE INDEX IF NOT EXISTS idx_complaint_no_trgm
...
CREATE INDEX IF NOT EXISTS idx_complaint_driver_status
  ON "Complaint" ("driverId", "status");

-- Complaint category for auto-assignment lookups
CREATE INDEX IF NOT EXISTS idx_complaint_category_status
...
CREATE INDEX IF NOT EXISTS idx_loading_driver_status_created
...
CREATE INDEX IF NOT EXISTS idx_refresh_token_family_active
